...
class BuyerEntity(UserEntity):
    ...
    def __init__(self, buyer_id: str, full_name: str, address: str, phone: Optional[str] = None):
        """
    ...
    def __repr__(self):
        return (f"BuyerEntity(buyer_id='{self.buyer_id}', full_name='{self.full_name}', address='{self.address}' "
                f"phone='{self.phone}')")